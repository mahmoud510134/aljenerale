...
// Url: https://aljjenerale.blogspot.com
// Version: 3
// License: free
// Date: 26/3/2019
// ---------------------------------------------------
...
// Date : 02-08-2011
// global arrays
// Mahmoud EL-Najjar/جميع الحقوق محفوظة لـ مدونة الجنرال صمم وكود من طرف
// https://aljjenerale.blogspot.com/
...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'مواضيع مدونة الجنرال';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'تاريخ النشر';
   var tocTool2 = 'Click to sort by date';
   var tocHead3 = 'جميع الاقسام';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note"> العدد الكلي لموضوعات مدونة الجنرال' + postTitle.length + ' موضوع<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">العدد الكلي لموضوعات مدونة الجنرال' + numDisplayed + ' موضوع \'';
...
function showToc() {
  ...
  else { alert("جاري تحميل فهرس مواضيع مدونة الجنرال **انتظر قليلاً**"); }
}
...
"<div id=\"toc-loading\">جاري تحميل فهرس مواضيع مدونة الجنرال **انتظر قليلاً**<br /><img align=\"middle\" src=\"http://2.bp.blogspot.com/-WK0-4ILTaL8/T0NjToWRWlI/AAAAAAAABmI/U5p3cqo9lOU/s1600/loading.gif\" /></div>";
